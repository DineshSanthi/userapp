...
//----------------------------------------
    ...
    isc.Page.setSkinDir("[ISOMORPHIC]/skins/Obsidian/")
...
//----------------------------------------
    ...
    // -----------------------------------------------------   
    // css3 and spriting are required for the Obsidian skin
    var useCSS3 = isc.Browser.useCSS3,
        useSpriting = isc.Browser.useSpriting;
        
    if (!useCSS3 || !useSpriting) {
        isc.logWarn("Obsidian skin makes use of HTML5 features which may be " +
    ...
    if (isc.ListGrid) {
        ...
        isc.ListGrid.changeDefaults("bodyDefaults", {
    ...
    if (isc.CheckboxItem) {
        ...
        isc.CheckboxItem.addProperties({
            ...
            // For Obsidian there is no default "unset" image
    ...
    if (isc.RichTextEditor) {
        isc.RichTextEditor.addProperties({
            ...
            editAreaBackgroundColor: "#000000",
    ...
    if (isc.setCurrentSkin) isc.setCurrentSkin("Obsidian", "Flat");
